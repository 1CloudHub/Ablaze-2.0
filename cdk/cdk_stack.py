...
class CdkStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        user_data_script.add_commands(
            ...
            f"git clone --branch cexp_nova https://{github_token}@github.com/1CloudHub/DevCraft-in-a-Box-CEXP-Code.git CEXPAPP > gitclone.log 2>&1",
...
EOF''',
  ...
  --policy file://bucket-policy.json''',
            ...
            f"git clone --branch backend_nova https://{github_token}@github.com/1CloudHub/DevCraft-in-a-Box-CEXP-Code.git DB_table_git",
            "cd DB_table_git",
            f"""cat <<'EOF' > .env
REGION_USED={self.region}
OPENSEARCH_ENDPOINT={opensearch_endpoint}
